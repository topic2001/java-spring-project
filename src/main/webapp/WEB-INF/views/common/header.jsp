...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/header.css?ver=3" />
...
<!--==============================헤더시작======================================-->
  <div id="map-modal-container"> <!--검색 모달창때문에 감쌈  -->
	<div id="side-menu" class="side-menu-off">
			...
			<div class="side_content_layout">
				...
				<div class="accordion_01">
						...
						<div class="layout_wrap">
							...
							<div class="layout_type">
								<a href="${pageContext.request.contextPath}/hotel">호텔</a><br />
							</div>
							<div class="layout_type">
				...
				<div class="location">
					<a class="nontop_myplace" href="${pageContext.request.contextPath}/myplace">내주변</a>
				</div>
		...
		<div id="map-modal-bgh" onclick="closemodalh();">
		</div>
</div>
<!--===============================반응형 검색 모달=============================-->
   ...
   <div class="header">
      <div class="header_div">
          ...
          <!--메인로고-->
           ...
           <!--메뉴그룹-->
           <div class="grp_menu">
               <div class="nontop_color" ><a class="nontop_myplace" style="text-decoration: none; color: rgba(255,255,255,0.8); "href="${pageContext.request.contextPath}/myplace">내주변</a></div>
               <div><a class="nontop_color" style="text-decoration: none; color: rgba(255,255,255,0.8);" href="${pageContext.request.contextPath}/myinfo/myinfo_reserve">예약내역</a></div>	
               <div class="grp_dropdown">
              <button disabled class="grp_dropbtn nontop_color">더보기</button>
            ...
            <c:if test="${member== null }"><div><a href="#">로그인</a></div></c:if> --%>
             ...
             <c:if test="${loginUser == null }">
            <div class="login_a nontop_color"><a class="nontop_login" style="text-decoration: none; color: rgba(255,255,255,0.8); " href="${pageContext.request.contextPath}/login">로그인</a></div>   
             </c:if>
             ...
             <c:if test="${loginUser != null }">
              ...
              <div class="dropdown-logout">
                ...
                <c:if test="${loginUser.mem_access != '회원' }">
	                <a href="${pageContext.request.contextPath}/kadmin_page">관리페이지</a>
                </c:if>
                <a href="${pageContext.request.contextPath}/logout">로그아웃</a>
              </div>
            </div>  
